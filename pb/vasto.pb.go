...
type VastoStoreClient interface {
	BootstrapCopy(ctx context.Context, opts ...grpc.CallOption) (VastoStore_BootstrapCopyClient, error)
...
func (c *vastoStoreClient) BootstrapCopy(ctx context.Context, opts ...grpc.CallOption) (VastoStore_BootstrapCopyClient, error) {
...
func (x *vastoStoreBootstrapCopyClient) Send(m *UpdateEntry) error {
	return x.ClientStream.SendMsg(m)
}

func (x *vastoStoreBootstrapCopyClient) CloseAndRecv() (*Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Empty)
...
type VastoStoreServer interface {
	BootstrapCopy(VastoStore_BootstrapCopyServer) error
...
func _VastoStore_BootstrapCopy_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(VastoStoreServer).BootstrapCopy(&vastoStoreBootstrapCopyServer{stream})
}
...
func (x *vastoStoreBootstrapCopyServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *vastoStoreBootstrapCopyServer) Recv() (*UpdateEntry, error) {
	m := new(UpdateEntry)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
